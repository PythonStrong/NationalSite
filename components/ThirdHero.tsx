    ...
    <div >
      ...
      <div className='flex hero  items-center flex-col px-6 justify-center h-[80vh] xl:w-[1190px] m-auto rounded-3xl mt-36 md:mx-24'>
        <div className='relative z-50'>
          <h1 className='text-white xl:text-[60px] md:text-[30px] sm:text-[30px] font-bold  mb-12'>Chust Milliy<br /> Pichog'i </h1>
        ...
        <Image src={knife} alt='unnamed' className='absolute z-10 brightness-50 h-[60%] xl:ml-[530px] w-[40%]' />
      </div>


      {/* for map and texts  */}
      <div className='flex  justify-around mt-24 map'>
        <Image src={knife} alt='map' className='rounded-2xl cursor-pointer w-[40%] flip_img' />

        <div className='flex  flex-col xl:w-[500px] gap-6'>
          <h1 className='text-2xl font-bold'>Chust Pichog'i Haqida</h1>
          <h1 className='text-gray-400'>Lorem ipsum dolor Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate perferendis rerum atque quas magnam, rem fugiat aliquid repellat neque delectus dicta assumenda nemo itaque inventore animi! Eos tenetur blanditiis eveniet? sit amet consectetdsahsyyubs jdhfuhyuyurb hfuyurbhubd fdbausugfvuh jsdnuhyubhs ndbhyberhefnui hjbdfgyuygsat7vquurint ut doloremque eaque unde harum autem veniam, pariatur temporibus quaerat, adipisci blanditiis veritatis obcaecati praesentium repellat nisi rem sit atque ad. Quas earum libero cupiditate deleniti molestias et perspiciatis esse delectus atque eos, vel ab magni expedita tempora quae distinctio, nam facere.</h1>
